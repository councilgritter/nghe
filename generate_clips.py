...
First run this to see the voices and pick a Southern one:
    python generate_clips.py --list-voices

Then spot-check 40 clips BEFORE committing to the full run:
    python generate_clips.py --voice "<name>" --limit 40

Then the full run (resumable — safe to Ctrl-C and restart):
    python generate_clips.py --voice "<name>"
"""
