...
a tone, a vowel, a first consonant, or a final consonant. Tuned for Southern speech.

Nothing runs on your own computer. The audio is generated by
[VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS) in Google Colab and served
...
Colab needs permission to push the audio back to your repo.
...
Top to bottom. The notebook explains each one. Three things to know:

**Listen to the 40-clip sample in step 5.** If the voice mangles isolated
syllables, you want to find out before a long run, not after. Check that the
tone you hear matches the tone mark written.

**The full run in step 6 takes a while and is resumable.** If Colab disconnects,
re-run the cell — it skips everything already done. Everything is saved in your
